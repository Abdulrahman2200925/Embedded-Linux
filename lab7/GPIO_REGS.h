...
#define MAX_GPIO_PINS          15U
#define MAX_GPIO_MODES         3U
#define MAX_GPIO_AF          15U


#define GPIO_PIN1_MASK         0x0001U
#define GPIO_PIN2_MASK         0x0002U
#define GPIO_PIN0_MASK         0x0004U
...
#define GPIO_AFRH_MASK(pin)        (0x0FU << (((pin) - 8) * 4))
#define GPIO_BSRR_SET_MASK(pin)        (0x01U << (pin))
#define GPIO_BSRR_RESET_MASK(pin)      (0x01U << ((pin) + 16))
